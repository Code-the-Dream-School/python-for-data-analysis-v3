...
- **Lesson content** — the instructional material students read
...
**Read the content, test the code examples, and tell us what's confusing or broken.**

Specifically:
- Try running any code examples yourself
- Note anything that felt unclear or assumed too much prior knowledge
- Flag errors, typos, or outdated instructions
- Check whether assignment prompts are clear and achievable for a beginner

Open an issue for anything you find. Be as specific as possible: include the file name, what you expected, and what you actually saw.

### If you want to suggest specific wording or fixes

Open a pull request against `main`. Keep PRs focused — one issue, one PR. A brief description of what you changed and why is enough context.

We welcome PRs that:
- Fix errors or broken examples
- Clarify confusing explanations
- Improve assignment prompts
- Improve mentor teaching notes

Please don't open PRs that restructure whole lessons or add new topics without first opening an issue to discuss — the course scope is intentional and changes to structure need maintainer sign-off.
